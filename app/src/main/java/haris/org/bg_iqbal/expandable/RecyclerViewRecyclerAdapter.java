package haris.org.bg_iqbal.expandable;
...
import haris.org.bg_iqbal.rci.ItemModel;
...
public class RecyclerViewRecyclerAdapter extends RecyclerView.Adapter<RecyclerViewRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (position % 2 == 0){
            holder.isi.setText("ini isinya asal kamu tahu");
        }
        else {
            holder.isi.setText("ini isinya asal kamu GAK tahu");
        }
